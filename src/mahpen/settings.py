"""
Django settings for mahpen project.
...
SECRET_KEY = 'django-insecure-m%v3lm_pj4f1esbhyucgo*9swv@1c#@6hkb%*_52)&mv3=5a&4'
...
WSGI_APPLICATION = 'mahpen.wsgi.application'
